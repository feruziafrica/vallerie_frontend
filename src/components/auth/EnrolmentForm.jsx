...
//     phone:          '',
//     course:         preselectedCourse?.id ? String(preselectedCourse.id) : '',
//     payment_method: 'paystack',   // ← updated: single provider now
//   });
//   const [errors, setErrors] = useState({});
//   const [focused, setFocused] = useState('');
//   const [submitting, setSubmitting] = useState(false);
...
//   // Sync preselected course — unchanged
//   useEffect(() => {
//     if (preselectedCourse?.id) {
//       setForm(f => ({ ...f, course: String(preselectedCourse.id) }));
//     }
...
//         student_email:  form.student_email.trim().toLowerCase(),
//         phone:          form.phone.trim(),
//         course:         Number(form.course),   // ← was course_id, now course
//         payment_method: form.payment_method,   // always 'paystack'
//       });
...
//             color: '#d97706', fontSize: '13px', fontWeight: '700',
//             background: 'none', border: 'none', cursor: 'pointer',
//             padding: 0, marginBottom: '14px', fontFamily: 'inherit',
//           }}
//         >
//           <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
//             <polyline points="15 18 9 12 15 6" />
...
//             background: '#fef3c7', borderRadius: '999px', padding: '3px 11px',
//           }}>
//             <span style={{
//               fontSize: '9px', fontWeight: '800', color: '#92400e',
//               letterSpacing: '0.1em', textTransform: 'uppercase',
...
//         </h2>
//         {preselectedCourse?.name && (
//           <p style={{ fontSize: '12px', color: '#78716c', margin: '4px 0 0', lineHeight: 1.4 }}>
//             Enrolling in{' '}
//             <strong style={{ color: '#1c1917' }}>{preselectedCourse.name}</strong>
//           </p>
//         )}
...
//         border: '1.5px solid #f0efee', padding: '18px',
...
//             error={errors.phone}
//             hint="Pre-fills M-Pesa on the Paystack checkout page"
//           >
//             <input
//               type="tel"
//               placeholder="+254 7XX XXX XXX"
...
//           {/* API error banner — unchanged */}
//           <AnimatePresence>
//             {submitError && (
//               <motion.div
//                 initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
//                 style={{
//                   background: '#fef2f2', borderRadius: '9px', padding: '10px 12px',
//                   border: '1px solid #fecaca', fontSize: '12px', color: '#dc2626',
//                   display: 'flex', alignItems: 'flex-start', gap: '7px',
//                 }}
//               >
...
//       <div style={{
//         display: 'flex', alignItems: 'center', justifyContent: 'center',
//         gap: '18px', marginTop: '12px',
//       }}>
//         {[
//           '🔒 Secure',
//           '✉ Credentials by email',
//           '⚡ M-Pesa & Card accepted',   // ← updated
//         ].map(t => (
//           <span key={t} style={{ fontSize: '10px', color: '#a8a29e', fontWeight: '600' }}>
//             {t}
//           </span>
//         ))}
//       </div>
